...
{
    public class GuideElement : OakIdeas.EBook.EPUB.BaseElement
    {
        ...
        public GuideElement(string id, string version, string uniqueIdentifier, string language, string direction)
            : base()
        {
        ...
        public GuideElement(string version, string uniqueIdentifier)
            : base()
        {
            if (!String.IsNullOrEmpty(version))
            {
