...
{
    public class PackageElement : OakIdeas.EBook.EPUB.BaseElement
    {
        ...
        public PackageElement(string id, string version, string uniqueIdentifier, string language, string direction)
            : base()
        {
        ...
        public PackageElement(string version, string uniqueIdentifier)
            : base()
        {
            if (!String.IsNullOrEmpty(version))
            {
