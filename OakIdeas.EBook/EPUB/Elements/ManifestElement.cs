...
{
    public class ManifestElement : OakIdeas.EBook.EPUB.BaseElement
    {
        ...
        public ManifestElement(string id, string version, string uniqueIdentifier, string language, string direction)
            : base()
        {
        ...
        public ManifestElement(string version, string uniqueIdentifier)
            : base()
        {
            if (!String.IsNullOrEmpty(version))
            {
