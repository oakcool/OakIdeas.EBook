...
{
    public class SpineElement : OakIdeas.EBook.EPUB.BaseElement
    {
        ...
        public SpineElement(string id, string version, string uniqueIdentifier, string language, string direction)
            : base()
        {
        ...
        public SpineElement(string version, string uniqueIdentifier)
            : base()
        {
            if (!String.IsNullOrEmpty(version))
            {
