...
{
    public class AlphabetAttribute : OakIdeas.EBook.EPUB.Property, OakIdeas.EBook.EPUB.Attributes.IAttribute
    {
        ...
        public AlphabetAttribute()
        {
            ...
            this._prefix = "ssml";
            this._reference = "alphabet";
            this._namespace = "http://www.w3.org/2001/10/synthesis";
        }

        public AlphabetAttribute(string value)
            : base()
        {
            Value = value;
        }

        public AlphabetAttribute(string prefix, string reference, string nameSpace, bool defaultVocabulary)
        {
