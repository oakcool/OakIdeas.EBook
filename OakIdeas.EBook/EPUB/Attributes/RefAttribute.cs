...
{
    public class RefAttribute : OakIdeas.EBook.EPUB.Property, OakIdeas.EBook.EPUB.Attributes.IAttribute
    {
        ...
        public RefAttribute(string prefix, string reference, string nameSpace, bool defaultVocabulary)
        {
